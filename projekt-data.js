...
const projekt = {
  lekstuga: {
    ...
    inkop: [
      ...
      { namn: "Regel", dim: "45×95 mm, 3,6 m", antal: 6, enhet: "st", not: "Grundram", totalt: 480, skala: "perimeter" },
      { namn: "Golvbräda, tryckimpregnerad", dim: "120×22 mm, 2,1 m", antal: 18, enhet: "st", not: "", totalt: 990, skala: "area" },
      { namn: "Makadam", dim: "8–16 mm", antal: 1, enhet: "m³", not: "Dränering", totalt: 175, skala: "area" },
      { kategori: "Stomme och väggar" },
      { namn: "Regel", dim: "45×95 mm, 3,6 m", antal: 20, enhet: "st", not: "Väggstomlarna", totalt: 1600, skala: "perimeter" },
      { namn: "Locklistpanel", dim: "120×22 mm, 3,6 m", antal: 30, enhet: "st", not: "Fasad", totalt: 2100, skala: "perimeter" },
      { namn: "Råspont", dim: "22 mm, 3,6 m", antal: 15, enhet: "st", not: "Tak/innervägg", totalt: 900, skala: "area" },
      { kategori: "Tak" },
      ...
      { namn: "Fönsterparti", dim: "60×60 cm", antal: 1, enhet: "st", not: "Färdigt paket", totalt: 950, skala: "fast" },
      { namn: "Dörr", dim: "80×150 cm", antal: 1, enhet: "st", not: "Enkel innerdörr", totalt: 700, skala: "fast" },
  ...
  altan: {
    ...
    sammanfattning: "En trallad altan med stolpfundament, bärlinor och kantbrädor. Kan byggas fristående eller mot husvägg. Anpassningsbar storlek och höjd med valfritt räcke.",
    ...
    inkop: [
      { kategori: "Grund" },
      { namn: "Stolpe, tryckimpregnerad", dim: "120×120 mm, 1,8 m", antal: 6,  enhet: "st", not: "",                  totalt: 1140, skala: "perimeter" },
      ...
      { namn: "Balk",                       dim: "45×195 mm, 4,2 m", antal: 4,  enhet: "st", not: "Bärlinor",         totalt: 1000, skala: "area" },
      { namn: "Balk",                       dim: "45×145 mm, 3,0 m", antal: 6,  enhet: "st", not: "Tvärbalkar",       totalt: 1080, skala: "area" },
      { namn: "Skuldra mot hus",            dim: "45×195 mm, 4,2 m", antal: 1,  enhet: "st", not: "Fasadmontage",     totalt: 250,  skala: "fast" },
      { kategori: "Trallgolv" },
      { namn: "Trallbräda, tryckimpregnerad", dim: "28×120 mm, 4,2 m", antal: 35, enhet: "st", not: "",              totalt: 3325, skala: "area" },
      { kategori: "Räcke" },
      { namn: "Räckesstolpe",              dim: "70×70 mm, 1,1 m",   antal: 10, enhet: "st", not: "",                totalt: 1500, skala: "perimeter" },
      { namn: "Ledstång",                  dim: "45×70 mm, 4,2 m",   antal: 3,  enhet: "st", not: "",                totalt: 540,  skala: "perimeter" },
      { namn: "Räckesspjälor",             dim: "28×45 mm, 0,9 m",   antal: 40, enhet: "st", not: "Max 10 cm gap",   totalt: 1600, skala: "perimeter" },
      { kategori: "Trappa" },
      { namn: "Trappvång",                 dim: "45×220 mm, 2,4 m",  antal: 2,  enhet: "st", not: "",                totalt: 460,  skala: "fast" },
      { namn: "Trappsteg",                 dim: "28×120 mm, 90 cm",  antal: 8,  enhet: "st", not: "2 bräder/steg",   totalt: 560,  skala: "fast" },
      { kategori: "Fästelement" },
      { namn: "Konstruktionsskruv",        dim: "120 mm",            antal: 100, enhet: "st", not: "",               totalt: 290,  skala: "area" },
  ...
  pergola: {
    ...
    inkop: [
      { kategori: "Stomme" },
      { namn: "Stolpe, tryckimpregnerad", dim: "120\u00d7120 mm, 3,0 m", antal: 4, enhet: "st", not: "", totalt: 1156, skala: "perimeter" },
      { namn: "B\u00e4rbalk", dim: "45\u00d7195 mm, 3,6 m", antal: 2, enhet: "st", not: "Djupled", totalt: 370, skala: "perimeter" },
      { kategori: "Spj\u00e4ltak" },
      { namn: "Spj\u00e4la", dim: "45\u00d770 mm, 3,6 m", antal: 21, enhet: "st", not: "c/c 150 mm", totalt: 1155, skala: "area" },
      { kategori: "Infastning" },
